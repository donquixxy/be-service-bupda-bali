...
type User struct {
	...
	InveliPassword       string    `gorm:"column:inveli_password;"`
	...
	PaylaterApprovalDate null.Time `gorm:"column:paylater_approval_date;"`
	ActivationDate       null.Time `gorm:"column:activation_date;"`
}
