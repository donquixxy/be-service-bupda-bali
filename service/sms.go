...
func (service *SmsServiceImplementation) SendOTP(requestId string, phone string, otpCode string) {
	message := fmt.Sprintf("Kode Verifikasi Akun Bupda Bali Anda adalah: %s *JANGAN BERIKAN KODE INI KEPADA SIAPAPUN, TERMASUK PIHAK TEMAN BUNDA* Hubungi xxxxxxxx untuk bantuan.", otpCode)
